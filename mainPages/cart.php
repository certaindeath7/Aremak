...
<script>
    ...
    function addToCart(pid, quantity)
    {
        ...
        $.get("../mainActions/fetch_cart.php?pid="+pid+ "&quantity="+quantity,{}).done(function(data){
            var res = data;
            if(data)
                {
                    loadCart();
   ...
   function loadCart()
    ...
    variable.open("Get", "../mainActions/action_cart.php?", true);
    variable.send();
    }
    ...
    {
        $.get("../mainActions/action_delete_cart.php?pid="+pid,{}).done(function(data){
            var res = data;
            if(data)
                {
                    loadCart();
    ...
    function checkout()
    {
        ...
        $.get("../mainActions/delete_cart_afterCheckout.php?",{}).done(function(data){
            var res = data;
            if(data)
                {
        
                    window.location.href="../mainPages/index.php";
    ...
    <?php
                        ...
                        if(isset($_SESSION['uid']))
                        {
                            ...
                            if(isset($_REQUEST['pid']))
                            {
                                ...
                                echo' <script> addToCart('.$pid.', '.$quantity.'); </script>';
                            }
